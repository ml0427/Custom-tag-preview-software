...
This project is indexed by GitNexus as **Custom-tag-preview-software** (2055 symbols, 3343 relationships, 116 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
